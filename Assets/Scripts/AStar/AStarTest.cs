...
public class AStarTest : MonoBehaviour
{
    ...
    private void Start()
    {
        startPathTile = GameResources.Instance.perferredEnemyPathTile;
    ...
    private void SetStartPosition()
    {
        ...
        {
            startGridPosition = grid.WorldToCell(HelpUtilities.GetMouseWorldPosition());
    ...
    private void SetEndPosition()
    {
        ...
        {
            endGridPosition = grid.WorldToCell(HelpUtilities.GetMouseWorldPosition());

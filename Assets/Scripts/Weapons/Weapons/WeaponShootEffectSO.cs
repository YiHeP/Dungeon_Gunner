...
[CreateAssetMenu(fileName = "WeaponShootEffect_",menuName = "Scriptable Objects/Weapon/武器射击特效")]
public class WeaponShootEffectSO : ScriptableObject
{
    #region Header 武器射击特效
    [Space(10)]
    [Header("武器射击特效")]
    #endregion

    #region Tooltip
    [Tooltip("填入武器射击特效的颜色渐变器")]
    #endregion
    ...
    private void OnValidate()
    {
        ...
        HelpUtilities.ValidateCheckNullValues(this, nameof(weaponShootEffectPrefab), weaponShootEffectPrefab);
    }
#endif
    #endregion
